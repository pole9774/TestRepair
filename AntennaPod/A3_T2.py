...
el = driver.find_elements_by_id('de.danoeh.antennapod:id/txtvTitle')[1]
el.click()
time.sleep(1)

el = driver.find_element_by_id('de.danoeh.antennapod:id/action_search')
el.click()
time.sleep(1)
...
el = driver.find_elements_by_accessibility_id('New')[0]
el.click()
time.sleep(1)

el = driver.find_elements_by_accessibility_id('All')[0]
el.click()
time.sleep(1)

el = driver.find_elements_by_accessibility_id('Favorites')[0]
el.click()
time.sleep(1)
