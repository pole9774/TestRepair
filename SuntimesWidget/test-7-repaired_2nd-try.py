...
try:
    ...
    # Fix: Use the "selected" attribute instead of "outerHTML"
    if driver.find_element(AppiumBy.XPATH, "//android.support.v7.app.ActionBar.Tab[1]").get_attribute("selected") != "true":
        event_tab.click()
        time.sleep(1)
