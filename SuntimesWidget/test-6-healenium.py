...
desired_caps = {
	...
	"sessionKey": "SuntimesWidget_test-6"
}
...
try:
    ...
    el2 = driver.find_element(AppiumBy.XPATH, "//*[@text='Set Date']") # Healenium: UIAUTOMATOR selector changed to XPATH
    el2.click()
    time.sleep(3)

    el3 = driver.find_element(AppiumBy.XPATH, "//*[@text='Set']") # Healenium: UIAUTOMATOR selector changed to XPATH
    el3.click()
