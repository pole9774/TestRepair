...
try:
    ...
    el2 = driver.find_element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Set Alarm")')
    el2.click()
    time.sleep(3)
    ...
    el5 = driver.find_element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Schedule")')
    el5.click()
