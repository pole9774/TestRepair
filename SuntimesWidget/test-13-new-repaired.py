...
try:
    ...
    # Click on Basic Map (current selection)
    ...
    # Now we need to access the display options (Sunlight, Moonlight, Both)
    ...
    el = driver.find_element(AppiumBy.XPATH, '//android.widget.TextView[@text="Sunlight"]/../../android.widget.CheckBox')
    el.click()
    time.sleep(3)
    ...
    # Toggle Moonlight option (uncheck it first, since it's checked by default)
    el = driver.find_element(AppiumBy.XPATH, '//android.widget.TextView[@text="Moonlight"]/../../android.widget.CheckBox')
    el.click()
    time.sleep(3)
    ...
    # Go back by clicking outside the options menu
    driver.back()
    time.sleep(1)
    
    # Go back by clicking outside the main options menu
    driver.back()
    time.sleep(1)
    
    # Go back to the main screen by clicking outside the world map
    driver.back()
    time.sleep(1)
