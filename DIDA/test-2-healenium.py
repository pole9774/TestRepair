...
try:
    ...
    el3 = driver.find_element(AppiumBy.XPATH, "//*[@text='Sounds & Notifications']") # Healenium: UIAUTOMATOR selector changed to XPATH
    el3.click()
    time.sleep(3)

    el4 = driver.find_element(AppiumBy.XPATH, "//*[@text='Daily Alert']") # Healenium: UIAUTOMATOR selector changed to XPATH
    el4.click()
