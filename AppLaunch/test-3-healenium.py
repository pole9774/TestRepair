...
try:
    ...
    driver.find_element("xpath", "//*[@text='Settings']").click() # Healenium: UIAUTOMATOR selector changed to XPATH
    time.sleep(3)

    driver.find_element("id", 'com.simplemobiletools.applauncher:id/settings_customize_colors_label').click()
    time.sleep(3)

    driver.find_element("xpath", "//*[@text='Light']").click() # Healenium: UIAUTOMATOR selector changed to XPATH
    time.sleep(3)

    driver.find_element("xpath", "//*[@text='Dark']").click() # Healenium: UIAUTOMATOR selector changed to XPATH
