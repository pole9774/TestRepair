...
desired_caps = {
    ...
    "sessionKey": "AnkiDroid_test-7-new"
}
...
el = driver.find_element(AppiumBy.XPATH, "//*[@text='Manage note types']") # Healenium: UIAUTOMATOR selector changed to XPATH
el.click()
...
el = driver.find_element(AppiumBy.XPATH, "//*[@text='OK']") # Ok button
el.click()
