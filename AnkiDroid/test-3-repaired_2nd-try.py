...
# IMPORTANT: For Cloze notes, you must include cloze deletion markup, e.g. {{c1::something}}
el = driver.find_elements(AppiumBy.ID, "com.ichi2.anki:id/id_note_editText")[0]
el.clear()
el.send_keys("TestFront4 {{c1::cloze}}")  # <-- FIX for v2: must include cloze deletion markup
