...
# test case 2: Start main interface

time.sleep(10)

el = driver.find_elements(AppiumBy.ID, 'org.jak_linux.dns66:id/start_button')[0]
...
el = driver.find_element(AppiumBy.ID, 'org.jak_linux.dns66:id/switch_onboot')
el.click()
time.sleep(1)
