...
el = driver.find_elements(AppiumBy.ID, 'org.jak_linux.dns66:id/title')[3] # Show Notifications
el.click()
time.sleep(1)
...
el = driver.find_elements(AppiumBy.ID, 'org.jak_linux.dns66:id/title')[4] # About
el.click()
time.sleep(1)
