...
el = driver.find_elements_by_id('com.vrem.wifianalyzer:id/design_menu_item_text')[6]
el.click()
time.sleep(1)
...
el = driver.find_element_by_id('android:id/search_close_btn')
el.click()
time.sleep(1)