...
try:
    ...
    # Updated theme name from "Light theme" to "Light"
    el4 = driver.find_element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Light")')
    el4.click()
    time.sleep(3)

    # Updated theme name from "Dark theme" to "Dark"
    el5 = driver.find_element(AppiumBy.ANDROID_UIAUTOMATOR, 'new UiSelector().text("Dark")')
    el5.click()
