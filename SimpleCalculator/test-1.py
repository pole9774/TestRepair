...
try:
    ...
    # el4 = driver.find_elements(AppiumBy.ID, 'com.simplemobiletools.calculator:id/customization_text_color_label')[0]
    # el4.click()

    # branch
    el4 = driver.find_elements(AppiumBy.ID, 'com.simplemobiletools.calculator:id/customization_text_color')[0]
    el4.click()
