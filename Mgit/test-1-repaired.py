...
# Updated selector for Remote URL field - using class and text attributes
el = driver.find_element(AppiumBy.XPATH, '//android.widget.EditText[@text="Remote URL"]')
...
# Updated selector for Clone button
el = driver.find_element(AppiumBy.ID, 'com.manichord.mgit:id/cloneViewCloneButton')  # Clone
el.click()
time.sleep(60)
